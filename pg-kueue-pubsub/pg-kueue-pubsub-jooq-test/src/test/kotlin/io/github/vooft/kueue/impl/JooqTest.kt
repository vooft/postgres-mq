...
import io.github.vooft.kueue.jooq.jdbc.publish
...
class JooqTest : IntegrationTest() {
    ...
    fun `should produce to multiple topics and consume from multiple topics`(): Unit = runBlocking {
        HikariDataSource(
            ...
            with(HappyPathTest) {
                KueuePubSub.jooq(dataSource = it).happyPathTest()
            }
        }
    }
    ...
    fun `should send after transaction commit`(): Unit = runBlocking {
        ...
        val kueue = KueuePubSub.jooq(dataSource = dataSource)
        ...
        try {
            ...
            kueue.publish(topic, txn1, txnDsl)
            ...
            kueue.publish(topic, txn2, txnDsl)
            ...
            kueue.publish(topic, after, txnDsl)
